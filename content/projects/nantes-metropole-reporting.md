...
method: Développement d'un outil Java d'interrogation de l'API, intégration avec Eclipse BIRT pour la génération de rapports, puis campagne de tests destinée à valider la faisabilité avant industrialisation.
result: Un outil fonctionnel et une étude de faisabilité documentée, servant de base de décision pour la suite du projet.
links: []
images: []
---
